...
I have (or will) provide an updated requirements.txt file for pip install. If you're using Linux, some of the packages are not available via PIP so you're going to have to apt-get them yourself. The most recent version should work in every case. 
