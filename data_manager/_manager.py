...
class Data_Manager():
	...
	def set_last_pickup(self, chk = 1):
			...
			for pickup in recent_pickups:
				...
				admin = """UPDATE 
						...
						SET 
							...
							`Total Donation` = %s, 
							`Total Gallons` = %s,
							`Average Collection` = %s
						WHERE `Name` = "%s" 
						""" % ( pickup[1] , pickup[2], pickup[3], pickup[4], pickup[0] )
				# print admin, '\n'
		...
		print "Last pickups have been updated."
